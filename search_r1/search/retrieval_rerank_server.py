...
def search_endpoint(request: SearchRequest):
    ...
    retrieved_docs = retriever.batch_search(
        query_list=request.queries, num=request.topk_retrieval, return_score=False
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,
        help="Number of reranked passages for one query.",
    )
    parser.add_argument(
        "--reranker_model",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=32,
        help="Batch size for the reranker inference.",
    )
