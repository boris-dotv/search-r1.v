...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/home/peterjin/rag_retrieval_cache/nq/e5_train_retrieval_cache_2048.json",
    )
    parser.add_argument(
        "--test_retrieval_cache",
        type=str,
        default="/home/peterjin/rag_retrieval_cache/nq/e5_test_retrieval_cache_10000.json",
    )
    ...
    def add_context(example):
        example["context"] = format_reference(
            [
                corpus[docs["id"]]
                for docs in retrieval_cache[example["question"]][: args.topk]
            ]
        )
        return example
